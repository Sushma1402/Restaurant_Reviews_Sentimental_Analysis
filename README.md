...
In colab, I have explained steps to perform NLP using Bag of Words technique and I have predicted Positive and Negative reviews using Logistic Regression Algorithm and Naive Bayes Algorithm. The accuracy of the model is 92.54457050243113 % and F1 Score is 0.9538745387453875.

After doing sentiment analysis with NLP found that the data is Positive. 85% are Positive Reviews.
